...
*/
    ...
    define("DIR_tools",DIR_system.TOOLS_DIR);
	define("DIR_sql",DIR_BASE.SQL_DIR);
	
	define("DIR_wsclient",DIR_model."wsv2".DS."client".DS);
	define("DIR_wsserver",DIR_model."wsv2".DS."server".DS);
...
if (file_exists(DIR_BASE."custom_directories.php") and is_file(DIR_BASE."custom_directories.php")) {
	include(DIR_BASE."custom_directories.php");
}
?>