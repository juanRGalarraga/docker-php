...
/*
	...
	Author: DriverOp
*/
if (isset($objeto_contenido->metadata->calculadora) and ($objeto_contenido->metadata->calculadora != 'hidden')) {
...
try {
	...
	cLogging::Write(__FILE__ .' '.__LINE__ .$e->getMessage().' '.$_collectMsgs, LGEV_ERROR);
