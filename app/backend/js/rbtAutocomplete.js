/*
	...
	Updated: 2021-11-12
		...
		Retrasar la asignación del elemento objetivo hasta que sea necesario usarlo.
...
var rbtAutocomplete = function (elem, param) {
	...
	if (elem == null) {
		console.log('Target element delayed');
	} else {
	...
	/**
	* Summary. Establece el elemento objetivo.
	* @param InputElement 
	*/
	this.setTarget = function (targetElement) {
		elem = targetElement;
...
*/
	...
	document.addEventListener('DOMContentLoaded', ()=>{
		...
		document.body.appendChild(TheAutocomplete.theUl);
