...
/**
 * Verifica que el estado sea HAB, DES o ELI.
 * 
 */
	static function estado_is_valid($value){
		if(!defined("ESTADOS_VALIDOS")){
			define('ESTADOS_VALIDOS', ['HAB'=>'Habilitado', 'DES'=>'Deshabilitado', 'ELI'=>'Eliminado']);
		}
		return array_key_exists($value, ESTADOS_VALIDOS) || in_array($value, ESTADOS_VALIDOS);
	}
