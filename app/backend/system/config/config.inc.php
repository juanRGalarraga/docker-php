...
defined("MAINTITLE") || define("MAINTITLE","Kredito");
...
defined("INTERFACE_TYPE") || define("INTERFACE_TYPE","backend");

// Qué método se usa para establecer la sesión de usuario ('php'=Sesión de PHP, 'cookie'=Cookie en el navegador).
defined("SESSION_MODE") || define("SESSION_MODE","cookie");
// Nombre de la sesión de usuario o nombre de la cookie de sesión.
defined("USR_SESSION_NAME") || define("USR_SESSION_NAME", session_name());

// Las cosas lindas del sitio.
defined("SITE_favicon") || define("SITE_favicon",URL_img."favicon.png");
defined("SITE_mainlogo") || define("SITE_mainlogo",URL_img."mainlogo.svg");
defined("SITE_menulogo") || define("SITE_menulogo",URL_img."menulogo.svg");
...
define('DMZ_CONTENTS',["*watch","tools"]);
// Estos archivos AJAX están desmilitarizados
define('DMZ_ARCHIVOS',["checkLogin","genpass","gencbu"]);
