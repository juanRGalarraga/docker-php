...
const VALID_TYPE_PERMISOS = array('ADMIN', 'OPER');
const TIPOS_EVENTOS_LOG = array('ALL', 'DEBUG', 'INFO', 'WARN', 'ERROR', 'FATAL', 'OFF', 'TRACE');

const ESTADOS_VALIDOS = array(
	'HAB'=>'Habilitado',
	'DES'=>'Deshabilitado',
	'ELI'=>'Eliminado'
);
...
const TIPOS_CUENTAS = array('CA','CC','VIRTUAL');
const TIPOS_CUENTAS_DISPLAY = array(
	"CA"=>"Caja de Ahorros",
	"CC"=>"Cuenta Corriente",
	"VIRTUAL"=>"Billetera Vistual"
);
