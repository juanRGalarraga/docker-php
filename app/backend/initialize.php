...
// Si no está establecida la variable $_SERVER['DEVELOPE_NAME'] en el Virtual Host, por omisión es Rebrit, que es la base de todo el proyecto.
	defined('DEVELOPE_NAME') || define('DEVELOPE_NAME',(isset($_SERVER['DEVELOPE_NAME'])) ? $_SERVER['DEVELOPE_NAME']: 'rebrit');
...
// Si no se estableció el modo de interfaz, por omisión será 'core'.
	defined('INTERFACE_MODE') || define('INTERFACE_MODE',(isset($_SERVER['INTERFACE_MODE'])) ? strtolower($_SERVER['INTERFACE_MODE']): 'backend');
...
/*
	El archivo que se pasa como parámetro debe terminar en .cfg.php, caso contrario, la función se lo agrega!.
	Suponiendo que DIR_BASE vale 'c:/htdocs/www/rebrit/'
...
function LoadConfig($archivo, $default = null) {
	...
	$paths = array();
	$paths[] = DIR_config.$archivo;                                                   // c:/htdocs/www/rebrit/system/config/target.cfg
